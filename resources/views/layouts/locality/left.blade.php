...
@endif
   ...
   <!-- <div class="mob_filter_input">
      ...
      <div class="sort_by">
         <div class="sort_btn" id="btn_asc_mob"><span>Ascending</span></div>
         <div class="sort_btn" id="btn_dsc_mob"><span>Descending</span></div>
      </div>
   </div> -->
   <p class="mob_filter_topic">Sports</p>
   <div class="filter_check">
      @foreach ($data['sports'] as $index => $sport)
      <div class="mobile_login_check">
         <label class="mobile_login_label_checkbox">
            <input type="checkbox" class="sportCheckbox" value={{$sport}} />
            <span class="mobile_login_checkbox"></span>
            <p class="mob_filter_sector">{{$sport}}</p>
         </label>
      </div>
      @endforeach
   </div>
...
<div id="sports_popup_content" style="display: none;"> <!-- Initially hidden -->
   ...
   <div class="filter_check_mob">
      @foreach ($data['sports'] as $index => $sport)
      <div class="mobile_login_check_2">
         <label class="mobile_login_label_checkbox">
            <input type="checkbox" class="sportCheckbox" value={{$sport}} />
            <span class="mobile_login_checkbox"></span>
            <p class="mob_filter_sector new_filter_sector">{{$sport}}</p>
         </label>
      </div>
      @endforeach
   </div>
   <div class="filter_sport popup_close_icon">
