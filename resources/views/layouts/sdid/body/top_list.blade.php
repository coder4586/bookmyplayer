...
<script>
    ...
    ${photoarr.length > 0 ?
        ...
        `).join('') :
        `<img src="{{ env('AWS_S3_BASE_URL') }}/default/${academy.sport}_banner.webp" alt="Image" class="list_img active">`
    }
</a>
                  ...
                  <div class="coach_academy">
                     <span>${academy.sport}</span>
                       ...
                       <div class="list_location">
                           ...
                           <span class="fb_font location_add">${academy.distance ? `(${academy.distance.toFixed(2)} km)` : ""} ${[academy.address1, academy.address2, academy.city, academy.state, academy.postcode].filter(Boolean).join(', ')}</span>
                       </div>
   ...
   <div class="white_phone" data-toggle="modal" onclick="openLoginForm('${academy.id}', 'academy', '${academy.name}', '${academy.sport}')" data-target="#exampleModalCenter2">
    ...
    function initializeCarouselForElement(carouselElement) {
        ...
        function showSlides() {
            ...
            if (contactInfo) {
                contactInfo.textContent = `${slideIndex + 1}/${slides.length}`;
            }
            ...
            <div class="popup_details top_locals">
               ...
               <div class="local_flex">
                  ...
                  @if($index < 6) <div class="popup_box_up">
                     <div class="city_new_img_up">
                        <div class="display_flex">
                        <img src="{{ (is_null($academy->logo) || $academy->logo === "") ? env('AWS_S3_BASE_URL') . '/default/academy_default_logo.webp' : env('AWS_S3_BASE_URL') . '/academy/' . $academy->id . '/' . $academy->logo }}" alt="logo" loading="lazy">
               ...
               <div class="popup_wrap">
                ...
                @if($index <= 2)
                  <div class="popup_box">
                     ...
                     <a target="_blank" href="{{$academy->url}}"><img src="{{ (is_null($academy->logo) || $academy->logo === "") ? env('AWS_S3_BASE_URL') . '/default/academy_default_logo.webp' : env('AWS_S3_BASE_URL') . '/academy/' . $academy->id . '/' . $academy->logo }}" alt="logo" loading="lazy"></a>
                     </div>
                     <div class="popup_details">
                        <span class="popup_name"><a target="_blank" href="{{$academy->url}}">{{$academy->name}}</a></span>
