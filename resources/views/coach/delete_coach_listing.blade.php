...
@endpush
@push('scripts')
<script src="{{ asset('asset/js/coach_listing_v1.js') }}" defer></script>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-xl-8">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <h6 class="listing-title">Top {{ $data['sport']->name }} in {{ $data['location']->locality_name }} -</h6>
                    @else
                    <h6 class="listing-title">Top {{ $data['sport']->name }} Coaches in {{ $data['location']->locality_name }}</h6>
                    @endif
