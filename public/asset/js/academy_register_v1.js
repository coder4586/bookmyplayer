...
!(function (root, factory) {
  ...
  let  otpBox44 = $("#otp64");
    ...
    if($("#coach_sport").val() === "") {
      ...
      if ($("#coach_name").val() === "") {
        isValid = false;
        errorMessage = "Please enter your Academy Name.";
      }
  ...
  function checkUserDetailsExists(type, value) {
    const inputField = type === "email" ? $("#coach_email") : $("#coach_phone");
  ...
  //login js
    ...
    otpInputs3.on("input", function (e) {
      let o = $(".mob_otp_input6").index(this);
      1 === e.target.value.length
        ? o < $(".mob_otp_input6").length - 1 &&
          $(".mob_otp_input6")
            .eq(o + 1)
            .focus()
      ...
      $("#otp61, #otp62, #otp63, #otp64").on("input", function () {
        var e = !0;
        $("#otp61, #otp62, #otp63, #otp64").each(function () {
  ...
  $("#locationInput").on("input", async function () {
    ...
    locationList = localities.map(function (locality) {
      return {
        ...
        locality_name: locality.locality_name.charAt(0).toUpperCase() + locality.locality_name.slice(1),
        city: locality.city_id != 0 ? `${locality.city.charAt(0).toUpperCase() + locality.city.slice(1)}, ` : "",
        state: locality.state.charAt(0).toUpperCase() + locality.state.slice(1),
          ...
          if (otpBox11.val() && otpBox22.val() && otpBox33.val() && otpBox44.val()) {
              ...
              $.ajax({
                  ...
                  data: {
                      ...
                      lat:latitude,
                      lng: longitude,
                      cus_locality_name: custom_address,
                      cus_district:custom_city,
                      cus_state:custom_state,
                      cus_postcode:custom_postcode,
                      cus_address1:custom_address_1
                  },
                  success(e) {
                      if (e.status == 1) {
      ...
      success: function(response) {
        ...
        if (response.results && response.results.length > 0) {
          ...
          response.results.forEach(result => {
              ...
              displayContent = `
                  <div class="result-item" data-address="${localityName}" data-state="${state}" data-city="${district}" data-postcode="${result.postcode}">
