                ...
                <div class="col-lg-6">
                    <div class="coache-box">
                        ...
                        <div class="mid">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="viewed">
                                    <img src="https://f005.backblazeb2.com/file/bmpcdn90/asset/images/icon-viewed.svg" loading="lazy" alt="" width="14" height="14">${coach.views} people viewed since last week
                                </div>
                                <div class="graph">
                                    <img src="https://f005.backblazeb2.com/file/bmpcdn90/asset/images/icon-trending-up.svg" loading="lazy" alt="" width="20" height="20">${Math.floor(Math.random() * (80 - 20 + 1)) + 20}%
                                </div>
                            </div>
                        </div>
                        <div class="bot">
